<%@ page language="java" contentType="text/html; charset=UTF-8"
    pageEncoding="UTF-8"%>
<%
	String mem_id = "test";//service()[doGet,doPost]안에-지역변수
	//문제 
	//a.jsp페이지에서 생성한 객체 mem_id를 b.jsp에서 사용하고 싶다 
	//어떡하지?
	/*
	페이지 이동시(a.jsp에서) location.href를 사용하면 
	새로운 페이지(b.jsp)로 이동할 수 있다.
	이 때 주소창에 a.jsp에서 b.jsp로 변화되었음을 알 수 있다.
	기존에 요청이 끊어지고 새로운 요청이 들어왔다 의미
	따라서 요청이 유지되지 않고 있다.
	이런 경우 값을 유지할 수 없다.
